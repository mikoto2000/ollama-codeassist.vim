...
execute join(['function! vital#_ollamacodeassist#System#AsyncProcess#import() abort', printf("return map({'_vital_depends': '', 'execute': '', '_vital_loaded': ''}, \"vital#_ollamacodeassist#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
