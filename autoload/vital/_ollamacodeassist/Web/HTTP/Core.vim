...
execute join(['function! vital#_ollamacodeassist#Web#HTTP#Core#import() abort', printf("return map({'readfile': '', 'build_last_response': '', 'file_resolve': '', 'encodeURIComponent': '', '_vital_depends': '', 'curl_validate_retcode': '', 'build_response': '', 'decodeURI': '', 'tempname': '', 'build_settings': '', 'postdata': '', 'make_postfile': '', 'make_header_args': '', 'parseHeader': '', 'encodeURI': '', 'wget_validate_retcode': '', '_vital_loaded': ''}, \"vital#_ollamacodeassist#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:save_cpo = &cpo
set cpo&vim
