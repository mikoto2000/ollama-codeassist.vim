...
execute join(['function! vital#_ollamacodeassist#Web#AsyncHTTP#import() abort', printf("return map({'_vital_depends': '', 'post': '', 'get': '', 'request': '', '_vital_loaded': ''}, \"vital#_ollamacodeassist#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:save_cpo = &cpo
set cpo&vim
